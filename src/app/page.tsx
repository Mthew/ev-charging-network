...
const formSchema = z.object({
  ...
  primaryChargingLocation: z.string().min(1, "Selecciona la ubicación principal"),
...
export default function Home() {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    if (desiredLocations.length === 0) {
      setDesiredLocationsError("Debes agregar al menos una ubicación deseada para la nueva estación");
      return;
    }
...
✅ ID de registro: ${result.data.submissionId}
...
¡Gracias por ayudarnos a planificar la red de carga para vehículos eléctricos!`);
        ...
        alert(`Error al enviar el formulario: ${result.message || 'Error desconocido'}. Por favor intenta de nuevo.`);
      }
    } catch (error) {
      console.error('Error submitting form:', error);
      alert('Error de conexión al enviar el formulario. Verifica tu conexión a internet e intenta de nuevo.');
    } finally {
  ...
  const addDesiredLocation = () => {
    ...
    if (identifier && address) {
      setDesiredLocations([...desiredLocations, {
  ...
  const handleNewStationPlaceSelect = (place: { address: string; lat: number; lng: number; placeId: string }) => {
    setPendingLocation({ lat: place.lat, lng: place.lng });
    form.setValue("newStationAddress", place.address);
  };

  const handleChargingLocationPlaceSelect = (place: { address: string; lat: number; lng: number; placeId: string }) => {
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 leading-tight">
            ¿Quieres tener un{" "}
            <span className="text-primary">punto de carga</span>{" "}
            más cerca de ti?
          </h1>
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
            Parte de los retos en el despliegue de nueva infraestructura, va de la mano de realizar
            inversiones en nuevas estaciones sin saber qué impacto tendrá en los usuarios que la necesita.
          </p>
          ...
          {(!process.env.NEXT_PUBLIC_GOOGLE_MAPS_API_KEY ||
            ...
            <div className="mt-6 p-4 bg-yellow-500/10 border border-yellow-500/20 rounded-lg max-w-2xl mx-auto">
              <div className="flex items-center justify-center space-x-2 mb-2">
                ...
                <span className="text-yellow-400 font-semibold">Configure Google Maps API</span>
              </div>
              <p className="text-yellow-300 text-sm text-center mb-3">
                Para activar la funcionalidad completa de mapas y autocompletado de direcciones
              </p>
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-12">
            ...
            <div className="form-section">
              ...
              <p className="section-description">
                Con esta información entenderemos las condiciones técnicas para seleccionar los equipos
                y características más apropiadas para tu vehículo.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-white">Tipo Vehículo</FormLabel>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input {...field} placeholder="Ej: Renault / Zoe" className="custom-input" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input {...field} placeholder="Ej: KYZ902" className="custom-input" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="md:col-span-2">
                      <FormLabel className="text-white">Kms al Día Promedio</FormLabel>
                      <Select onValueChange={field.onChange} defaultValue={field.value}>
                        <FormControl>
                          <SelectTrigger className="custom-input">
                        ...
                        <SelectContent>
                          <SelectItem value="0-20">0-20 Kms/día</SelectItem>
                          <SelectItem value="21-50">21-50 Kms/día</SelectItem>
                          <SelectItem value="51-100">51-100 Kms/día</SelectItem>
                          <SelectItem value="101-200">101-200 Kms/día</SelectItem>
                          <SelectItem value="200+">Más de 200 Kms/día</SelectItem>
                        </SelectContent>
                      </Select>
                      <FormMessage />
                    </FormItem>
            ...
            <div className="form-section">
              <div className="flex items-center mb-6">
                ...
                <h2 className="section-heading">¿Dónde recargas tu vehículo?</h2>
              </div>
              <p className="section-description">
                Con esta información crearemos un perfil de carga inicial para buscar eficiencia
                en el costo del kwh y tiempos de recarga.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-white">Ubicación donde realizas la mayoría de tus recargas</FormLabel>
                      <Select onValueChange={field.onChange} defaultValue={field.value}>
                        <FormControl>
                          <SelectTrigger className="custom-input">
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="public">Estación Pública</SelectItem>
                          <SelectItem value="other">Otro</SelectItem>
                        </SelectContent>
                      </Select>
                      <FormMessage />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-white">Ingresa la dirección o sitio en Google Maps</FormLabel>
                      <FormControl>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="md:col-span-2">
                      <FormLabel className="text-white">Tipo de Cargador</FormLabel>
                      <Select onValueChange={field.onChange} defaultValue={field.value}>
                        <FormControl>
                          <SelectTrigger className="custom-input">
                        ...
                        <SelectContent>
                          <SelectItem value="ac-level1">Nivel 1 (AC) - 110V</SelectItem>
                          <SelectItem value="ac-level2">Nivel 2 (AC) - 240V</SelectItem>
                          <SelectItem value="dc-fast">Nivel 3 (DC) - Carga Rápida</SelectItem>
                          <SelectItem value="portable">Portátil AC</SelectItem>
                          <SelectItem value="wall">Cargador de Pared</SelectItem>
                        </SelectContent>
                      </Select>
                      <FormMessage />
                    </FormItem>
            ...
            <div className="form-section">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center">
                  ...
                  <h2 className="section-heading">¿Dónde deseas una nueva estación?</h2>
                </div>
                {desiredLocations.length > 0 && (
                  <div className="flex items-center space-x-2">
                    <span className="text-sm text-green-400 font-medium">
                      {desiredLocations.length} ubicación{desiredLocations.length !== 1 ? 'es' : ''} agregada{desiredLocations.length !== 1 ? 's' : ''}
                    </span>
              ...
              <p className="section-description">
                ...
                para tus necesidades de recarga. <span className="text-red-400 font-medium">Debes agregar al menos una ubicación.</span>
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-white">Identificador de la nueva ubicación</FormLabel>
                      <Select onValueChange={field.onChange} value={field.value}>
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="work">Trabajo</SelectItem>
                          <SelectItem value="university">Universidad</SelectItem>
                          <SelectItem value="shopping">Centro Comercial</SelectItem>
                          <SelectItem value="other">Otro</SelectItem>
                        </SelectContent>
                      </Select>
                      <FormMessage />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-white">Dirección o sitio en Google Maps</FormLabel>
                      <FormControl>
                        <GooglePlacesAutocomplete
                          value={field.value || ""}
                          onChange={field.onChange}
              ...
              {desiredLocationsError && (
                <div className="mb-6 p-3 bg-red-500/10 border border-red-500/20 rounded-md">
                  <p className="text-red-400 text-sm">{desiredLocationsError}</p>
                </div>
              )}
              ...
              {desiredLocations.length > 0 && (
                <div className="mb-6">
                  <h3 className="text-white font-semibold mb-4">Ubicaciones agregadas:</h3>
                  <div className="space-y-2">
                    {desiredLocations.map((location) => (
                      <Card key={location.id} className="p-4 bg-white/5 border-white/10">
                        <div className="flex justify-between items-center">
                          <div>
                            <span className="text-primary font-medium">{location.identifier}</span>
                          ...
                          <Button
                            ...
                            size="sm"
                            onClick={() => {
                              const newLocations = desiredLocations.filter(l => l.id !== location.id);
            ...
            <div className="form-section">
              <div className="flex items-center mb-6">
                ...
                <h2 className="section-heading">¿Cómo te contactamos cuando instalemos la estación?</h2>
              </div>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input {...field} placeholder="Tu nombre completo" className="custom-input" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input {...field} placeholder="Número de teléfono" className="custom-input" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input {...field} type="email" placeholder="tu@email.com" className="custom-input" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
